...
<nav class="navbar navbar-expand-md navbar-dark bgprotex">
  ...
  <div class="bemvindo">
    <?php
        ...
        ?>
        <p>Fique à vontade para clicar no botão abaixo para informações sobre as páginas do site</p>
  </div>

<a class='btn btn-sm btn-info help botaohelpindex' href='#'>
...
<script>  
                       $(".help" ).click(function(e) {
                        ...
                        Swal.fire({
                        title: 'Menu de Ajuda',
                        text: "Bem vindo ao sistema PROTEX, você esta na página inicial, através da barra de navegação situada na parte superior do site, você pode realizar lançamentos, gerenciar os seus lançamentos, dar baixas (na seção de gerenciar) cadastrar e gerenciar os seus grupos. Além disso sempre que quiser voltar para a página inicial você pode clicar em Página Inicial ou em PROTEX!",
...
<div class="bemvindo">
<p>Este botão estará presente em todas as páginas, situado no canto superior direito, assim como ilustrado nesta pagina -></p>
</div>
