...
<script>  
                       $(".help" ).click(function(e) {
                        ...
                        Swal.fire({
                        title: 'Menu de Ajuda',
                        text: "Bem vindo ao sistema PROTEX, você esta no CONTAS A PAGAR , através da barra de navegação situada na parte superior do site, você pode realizar lançamentos, gerenciar os seus lançamentos, dar baixas (na seção de gerenciar) cadastrar e gerenciar os seus grupos. Além disso sempre que quiser voltar para a página inicial você pode clicar em Página Inicial ou em PROTEX!",
    ...
    <div class = "titulolancamento"><p><b>Novo Lançamento - Contas a Pagar</b></p></div>
          ...
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" maxlength="20" id="historicopagar" name="historicopagar" placeholder="Digite o Histórico" required>
          </div>
          </div>
          <div class="form-group">
          <label for="historicolongopagar">Histórico Longo</label>
          <input type="text" maxlength="100" class="form-control" id="historicolongopagar" name="historicolongopagar" placeholder="Digite o Histórico Longo">
          </div>
