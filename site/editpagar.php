...
<script>  
                       $(".help" ).click(function(e) {
                        ...
                        Swal.fire({
                        title: 'Menu de Ajuda',
                        text: "Bem vindo ao sistema PROTEX, você esta no EDITAR DADOS CONTAS A PAGAR, onde você pode alterar os dados do resgistro de contas a pagar que você selecionou em gerenciar lançamentos contas a pagar. Através da barra de navegação situada na parte superior do site, você pode realizar lançamentos, gerenciar os seus lançamentos, dar baixas (na seção de gerenciar) cadastrar e gerenciar os seus grupos. Além disso sempre que quiser voltar para a página inicial você pode clicar em Página Inicial ou em PROTEX!",
    ...
    <div class="formpagar">
    <form action="saveEditPagar.php" method="POST">
          <div class = "titulolancamento"><p><b>Editar Dados - Contas a Pagar</b></p></div>
          <div class="form-group">
            <label for="credorpagar">Nome do Credor</label>
            <input type="text" class="form-control" id="credorpagar" name="credorpagar" value="<?php echo $credor ?>" required>
          </div>
          <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
              ...
              <select id="subgrupopagar" name="subgrupopagar" class="form-control" required>
          ...
          <div class="form-group col-md-3">
            ...
            <input type="date" class="form-control" id="vencimentopagar" name="vencimentopagar" value="<?php 
          ...
          <div class="form-group col-md-3">
            <label for="valorpagar">Valor</label>
            <input type="number" class="form-control" id="valorpagar" name="valorpagar" value="<?php echo $valor ?>" required>
          </div>
          <div class="form-group col-md-6">
            <label for="historicopagar">Histórico</label>
            <input type="text" class="form-control" id="historicopagar" name="historicopagar" value="<?php echo $historico ?>" required>
          </div>
          </div>
          <input type="hidden" name="id" value="<?php echo $id ?>">
          <div class="form-group">
          <label for="historicolongopagar">Histórico Longo</label>
          <input type="text" class="form-control" id="historicolongopagar" name="historicolongopagar" value="<?php echo $historicolongo ?>" required>
          </div>
