...
<script>  
  ...
  <div class= "containerlançamentos">
      <div class="titulolancamentos">
        <p><b>Contas a Pagar - Relatórios</b></p>
      </div>
  </div>

  <div class="filtrodata">
    <form action="pdfpagar.php"  target="_blank"  method="POST">
    ...
    <div class="form-group col-md-12">
    <button type="submit" name="submit" id="submit" class="gerarpagar btncentro btn btn-secondary">Gerar Relatório</button>
