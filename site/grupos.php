...
<script>  
                       $(".help" ).click(function(e) {
                        ...
                        Swal.fire({
                        title: 'Menu de Ajuda',
                        text: "Bem vindo ao sistema PROTEX, você esta no CADASTRO DE NOVO GRUPO, onde você pode cadastrar um novo grupo. Através da barra de navegação situada na parte superior do site, você pode realizar lançamentos, gerenciar os seus lançamentos, dar baixas (na seção de gerenciar) cadastrar e gerenciar os seus grupos. Além disso sempre que quiser voltar para a página inicial você pode clicar em Página Inicial ou em PROTEX!",
    ...
    <div class= "titulonovogrupo"><p><b>Cadastro de Novo Grupo</b></p></div>
    <div class="novogrupoform">
        <form action="gruposprocessa.php" method="POST">

        <div class="form-group col-md-12">
            <label for="novogrupo">Novo Grupo</label>
            <input type="text" class="form-control" id="novogrupo" minlength="3" maxlength="30" name="novogrupo" placeholder="Nome do Grupo" required>
          </div>
